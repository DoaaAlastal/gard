		    	...
		    	<div class="m-portlet__head">
					<div class="m-portlet__head-caption">
						<div class="m-portlet__head-title">
							...
							<!--begin::Form-->
							<form class="m-form m-form--fit m-form--label-align-right" method="POST" action="{{ url('admin/tag/'.$tag->id) }}">
                            {{ csrf_field() }} 
                            ...
                            <input type="hidden" name="id" value="{{$tag->id}}">
								<div class="m-portlet__body">
									...
									<div class="form-group{{ $errors->has('en_name') ? ' has-error' : '' }} m-form__group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<input type="text" class="form-control m-input" name="en_name" placeholder="Enter English tag Name"  value="{{$tag->en_name}}">
                                ...
                                @endif
                                    ...
                                    <div class="form-group{{ $errors->has('ar_name') ? ' has-error' : '' }} m-form__group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<input type="text" class="form-control m-input" name="ar_name" placeholder="Enter Arabic Tag Name"  value="{{$tag->ar_name}}">
											<span class="m-form__help">
                                            Arabic Tag Name.
											</span>
                                        </div>
