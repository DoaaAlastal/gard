		    	...
		    	<div class="m-portlet__head">
					<div class="m-portlet__head-caption">
						<div class="m-portlet__head-title">
							...
							<!--begin::Form-->
							<form class="m-form m-form--fit m-form--label-align-right" method="POST" action="{{ url('admin/service') }}" enctype="multipart/form-data">
                            {{ csrf_field() }} 
								<div class="m-portlet__body">
									...
									<div class="form-group{{ $errors->has('en_name') ? ' has-error' : '' }} m-form__group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<input type="text" class="form-control m-input" name="en_name" placeholder="Enter English Service Name"  value="{{ old('en_name') }}">
                                ...
                                @endif
									...
									<div class="form-group{{ $errors->has('ar_name') ? ' has-error' : '' }} m-form__group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<input type="text" class="form-control m-input" name="ar_name" placeholder="Enter Arabic Service Name"  value="{{ old('ar_name') }}">
											<span class="m-form__help">
												Arabic Service Name.
											</span>
                                        </div>
									...
									<div class="m-form__actions m-form__actions">
										<div class="row">
											<div class="col-lg-9 ml-lg-auto">
												...
												<a class="btn btn-secondary" href="/admin/service">Cancel</a>
											</div>
										</div>
									</div>
                                </div>
