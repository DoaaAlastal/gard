		    	...
		    	<div class="m-portlet__head">
					<div class="m-portlet__head-caption">
						<div class="m-portlet__head-title">
							...
							<!--begin::Form-->
							<form class="m-form m-form--fit m-form--label-align-right" method="POST" action="{{ url('admin/page') }}" enctype="multipart/form-data">
                            {{ csrf_field() }} 
								<div class="m-portlet__body">
									<div class="form-group{{ $errors->has('en_name') ? ' has-error' : '' }} m-form__group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<input type="text" class="form-control m-input" name="en_name" placeholder="Enter English Page Name"  value="{{ old('en_name') }}">
                                ...
                                @endif
                                    ...
                                    <div class="form-group{{ $errors->has('ar_name') ? ' has-error' : '' }} m-form__group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<input type="text" class="form-control m-input" name="ar_name" placeholder="Enter Arabic Page Name"  value="{{ old('ar_name') }}">
											<span class="m-form__help">
                                            Arabic Page Name.
											</span>
                                        </div>
                                ...
                                @endif
									...
									<div class="form-group{{ $errors->has('en_title') ? ' has-error' : '' }} m-form__group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<input type="text" class="form-control m-input" name="en_title" placeholder="Enter English Page Title"  value="{{ old('en_title') }}">
											<span class="m-form__help">
												English Page Title.
											</span>
                                        </div>
                                ...
                                @endif
									...
									<div class="form-group{{ $errors->has('ar_title') ? ' has-error' : '' }} m-form__group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<input type="text" class="form-control m-input" name="ar_title" placeholder="Enter Arabic Page Title"  value="{{ old('ar_title') }}">
											<span class="m-form__help">
												Arabic Page Title.
											</span>
                                        </div>
                                ...
                                @endif
									...
									<div class="form-group m-form__group row{{ $errors->has('en_content') ? ' has-error' : '' }}">
												...
												<div class="col-lg-4 col-md-9 col-sm-12">
												<textarea class="form-control m-input" id="en_content" name="en_content" rows="20" value="">{{old('en_content')}}</textarea>
									...
									<div class="form-group m-form__group row{{ $errors->has('ar_content') ? ' has-error' : '' }}">
												...
												<div class="col-lg-4 col-md-9 col-sm-12">
												<textarea class="form-control m-input" id="ar_content" name="ar_content" rows="20" value="">{{old('ar_content')}}</textarea>
