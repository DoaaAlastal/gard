		    	...
		    	<div class="m-portlet__head">
					<div class="m-portlet__head-caption">
						<div class="m-portlet__head-title">
							...
							<!--begin::Form-->
							<form class="m-form m-form--fit m-form--label-align-right" method="POST" action="{{ url('admin/currencies') }}">
                            {{ csrf_field() }} 
								<div class="m-portlet__body">
									<div class="form-group{{ $errors->has('en_name') ? ' has-error' : '' }} m-form__group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<input type="text" class="form-control m-input" name="en_name" placeholder="Enter English Currency Name"  value="{{ old('en_name') }}">
                                ...
                                @endif
                                    ...
                                    <div class="form-group{{ $errors->has('ar_name') ? ' has-error' : '' }} m-form__group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<input type="text" class="form-control m-input" name="ar_name" placeholder="Enter Arabic Currency Name"  value="{{ old('ar_name') }}">
											<span class="m-form__help">
                                ...
                                @endif
                                    ...
                                    <div class="form-group{{ $errors->has('sign') ? ' has-error' : '' }} m-form__group row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <input type="text" class="form-control m-input" name="sign" placeholder="Enter Currency Sign"  value="{{ old('sign') }}">
                                            <span class="m-form__help">
												Currency Sign.
											</span>
                                        </div>
