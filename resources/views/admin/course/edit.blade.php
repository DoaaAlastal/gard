    ...
    <!-- BEGIN PAGE Body-->
		    	...
		    	<div class="m-portlet__head">
					<div class="m-portlet__head-caption">
						<div class="m-portlet__head-title">
							...
							<!--begin::Form-->
							<form class="m-form m-form--fit m-form--label-align-right" method="POST" action="{{ url('admin/course/'.$course->id) }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                        ...
                                        <div class="m-form__actions m-form__actions">
                                            <div class="row">
                                                <div class="col-lg-9 ml-lg-auto">
                                                    ...
                                                    <a class="btn btn-secondary" href="/admin/course">Cancel</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="m-portlet__head">
            ...
            <div class="m-portlet__head-tools">
                <form  class="m-form m-form--fit m-form--label-align-right" method="post" enctype="multipart/form-data" action="{{url('admin/add-course-attachment')}}">
                    {{ csrf_field() }}
                    <div class="m-portlet__body">
                    ...
                    @foreach($course->attachments as $attachment)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{url('admin/delete-course-attachment', $attachment['id']) }}" class="text-danger deleteBtn" data-toggle="modal" data-target="#delete{{$attachment->id}}"><i class="fa fa-trash" style="font-size: 15px !important;"></i></a>
