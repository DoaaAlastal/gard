            ...
            <div class="m-portlet__head-tools">
                <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                        <a href="{{url('admin/course/create')}}" class="btn btn-accent m-btn m-btn--pill m-btn--custom m-btn--icon m-btn--air">
												<span>
                    ...
                    <li class="m-portlet__nav-item">
                        <a href="{{url('admin/course/export')}}" class="btn btn-success m-btn m-btn--pill m-btn--custom m-btn--icon m-btn--air">
												<span>
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_2">
                ...
                @foreach($courses as $course)
                    <tr>
                        ...
                        <td>
                            <a href="{{url('admin/course/'.$course->id.'/edit')}}" class="text-primary" ><i class="fa fa-pencil-square-o" style="font-size: 15px !important;"></i></a>
                            <a href="{{url('admin/course', $course['id']) }}" class="text-danger deleteBtn" data-toggle="modal" data-target="#delete{{$course->id}}"><i class="fa fa-trash" style="font-size: 17px !important;"></i></a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
