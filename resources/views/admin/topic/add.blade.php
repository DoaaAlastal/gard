...
@section('content')
    ...
    <div class="m-portlet">
        ...
        <!--begin::Form-->
        <form class="m-form m-form--fit m-form--label-align-right" method="POST" action="{{ url('admin/topic/store') }}" enctype="multipart/form-data">
            {{ csrf_field() }}
                    ...
                    <div class="m-form__actions m-form__actions">
                        <div class="row">
                            <div class="col-lg-9 ml-lg-auto">
                                ...
                                <a class="btn btn-secondary" href="{{url('/admin/course-topics/'.$course->id)}}">Cancel</a>
                            </div>
                        </div>
                    </div>
                </div>
