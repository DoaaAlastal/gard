    ...
    <div class="m-portlet m-portlet--mobile">
								...
								<div class="m-portlet__head-tools">
									<ul class="m-portlet__nav">
										<li class="m-portlet__nav-item">
											<a href="{{url('admin/permission/create')}}" class="btn btn-accent m-btn m-btn--pill m-btn--custom m-btn--icon m-btn--air">
												<span>
							...
							<div class="m-portlet__body">
                                ...
                                <tr>
									<td> {{$item->name}} </td>
                                   <td>
                                   <a href="{{url('admin/permission/edit/'.$item->id)}}" class="text-primary" ><i class="fa fa-pencil-square-o" style="font-size: 15px !important;"></i></a>
                                    </td>
								</tr>
						@endforeach
									</tbody>
