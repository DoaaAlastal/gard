    ...
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            ...
            <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                ...
                <li class="m-nav__item">
                    <a href="{{url('admin/section/create')}}" class="m-nav__link">
											<span class="m-nav__link-text">
												Section
											</span>
                    </a>
		    	...
		    	<div class="m-portlet__head">
					<div class="m-portlet__head-caption">
						<div class="m-portlet__head-title">
							...
							<!--begin::Form-->
							<form class="m-form m-form--fit m-form--label-align-right" method="POST" action="{{ url('admin/section') }}" enctype="multipart/form-data">
                            {{ csrf_field() }} 
								<div class="m-portlet__body">
									...
									<div class="form-group{{ $errors->has('en_title') ? ' has-error' : '' }} m-form__group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<input type="text" class="form-control m-input" name="en_title" placeholder="Enter English Section Title"  value="{{ old('en_title') }}">
                                ...
                                @endif
									...
									<div class="form-group{{ $errors->has('ar_title') ? ' has-error' : '' }} m-form__group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<input type="text" class="form-control m-input" name="ar_title" placeholder="Enter Arabic Section Title"  value="{{ old('ar_title') }}">
											<span class="m-form__help">
                                ...
                                @endif
									...
									<div class="form-group {{ $errors->has('icon_class') ? ' has-error' : '' }} m-form__group row">
											...
											<div class="col-lg-4 col-md-9 col-sm-12">
												<input class="form-control m-input" type="text" value="{{old('icon_class')}}" id="icon_class" name="icon_class">
											</div>
										</div>
									...
									<div class="form-group {{ $errors->has('color') ? ' has-error' : '' }} m-form__group row">
											...
											<div class="col-lg-4 col-md-9 col-sm-12">
												<input class="form-control m-input" type="color" value="{{old('color')}}" id="color" name="color">
											</div>
										</div>
