		    	...
		    	<div class="m-portlet__head">
					<div class="m-portlet__head-caption">
						<div class="m-portlet__head-title">
							...
							<!--begin::Form-->
							<form class="m-form m-form--fit m-form--label-align-right" method="POST" action="{{ url('admin/category/'.$category->id) }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <input type="hidden" name="id" value="{{$category->id}}">
								<div class="m-portlet__body">
									...
									<div class="form-group{{ $errors->has('en_name') ? ' has-error' : '' }} m-form__group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<input type="text" class="form-control m-input" name="en_name" placeholder="Enter English Category Name"  value="{{ $category->en_name }}">
                                ...
                                @endif
                                    ...
                                    <div class="form-group{{ $errors->has('ar_name') ? ' has-error' : '' }} m-form__group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<input type="text" class="form-control m-input" name="ar_name" placeholder="Enter Arabic Category Name"  value="{{ $category->ar_name}}">
											<span class="m-form__help">
									...
									<div class="form-group m-form__group row {{ $errors->has('parent_id') ? ' has-error' : '' }}">
												...
												<div class="col-lg-4 col-md-9 col-sm-12" readOnly>
												<select class="form-control m-input" id="parent_id" name="parent_id">
												<option value=""> Select Parent </option>
                              @foreach($categories as $category)
                               <option {{($category->parent_id)==$category->id?"selected":""}} value='{{$category->id}}'>{{$category->en_name}}</option>
                            @endforeach
												</select>
									...
									<div class="form-group m-form__group row{{ $errors->has('en_description') ? ' has-error' : '' }}">
												...
												<div class="col-lg-4 col-md-9 col-sm-12">
												<textarea class="form-control m-input" id="en_description" name="en_description" rows="3" value="">{{$category->en_description}}</textarea>
									...
									<div class="form-group m-form__group row{{ $errors->has('ar_description') ? ' has-error' : '' }}">
												...
												<div class="col-lg-4 col-md-9 col-sm-12">
												<textarea class="form-control m-input" id="ar_description" name="ar_description" rows="3" value="">{{$category->ar_description}}</textarea>
							...
							<div class="form-group m-form__group row{{ $errors->has('icon') ? ' has-error' : '' }}">
								...
								<div></div>
								<div class=" col-lg-4 col-md-9 col-sm-12">
									<input type="file" class="custom-file-input" id="icon" name="icon" value="{{ $category->icon }}">
