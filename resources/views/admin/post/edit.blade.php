    ...
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            <h3 class="m-subheader__title m-subheader__title--separator">
                Edit @if($post->type=='news') News @elseif($post->type=='articles') Article @endif
            </h3>
            <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                ...
                <li class="m-nav__item">
                    <a href="{{url('admin/posts/'.$post->type)}}" class="m-nav__link">
											<span class="m-nav__link-text">
												{{$post->type}}
											</span>
                    </a>
		    	...
		    	<div class="m-portlet__head">
					<div class="m-portlet__head-caption">
						<div class="m-portlet__head-title">
							...
							<!--begin::Form-->
							<form class="m-form m-form--fit m-form--label-align-right" method="POST" action="{{ url('admin/posts/'.$post->id) }}" enctype="multipart/form-data">
                            {{ csrf_field() }} 
									...
									<div class="m-form__actions m-form__actions">
										<div class="row">
											<div class="col-lg-9 ml-lg-auto">
												...
												<a class="btn btn-secondary" href="/admin/posts/{{$post->type}}">Cancel</a>
											</div>
										</div>
									</div>
                                </div>
