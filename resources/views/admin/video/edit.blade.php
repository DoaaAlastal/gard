...
@section('content')
    ...
    <!-- BEGIN PAGE Body-->
        ...
        <div class="m-portlet">
            ...
            <!--begin::Form-->
            <form class="m-form m-form--fit m-form--label-align-right" method="POST" action="{{ url('admin/video/'.$video->id) }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="m-portlet__body">
                    ...
                    <div class="form-group m-form__group row{{ $errors->has('ar_description') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <textarea class="form-control m-input" id="ar_description" name="ar_description" rows="3" value="">{{$video->ar_description}}</textarea>
