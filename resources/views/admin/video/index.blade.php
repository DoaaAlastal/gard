                ...
                <div class="m-portlet__head-tools">
                    <ul class="m-portlet__nav">
                        <li class="m-portlet__nav-item">
                            <a href="{{url('admin/video/create')}}" class="btn btn-accent m-btn m-btn--pill m-btn--custom m-btn--icon m-btn--air">
												<span>
                                            ...
                                            <div class="m-portlet__body">
                                                <div class="m-widget19">
                                                    ...
                                                    <div class="m-widget19__action">
                                                        ...
                                                        <a role="button" class="btn btn-primary btn-sm" href="{{url('admin/video/'.$item->id.'/edit')}}" ><i class="fa fa-pencil-square-o" style="font-size: 15px !important;"></i> Edit</a>
                                                        <a role="button" class="btn btn-danger btn-sm deleteBtn"  href="{{url('admin/video', $item['id']) }}"  data-toggle="modal" data-target="#delete{{$item->id}}"><i class="fa fa-trash" style="font-size: 17px !important;"></i> Delete</a>
