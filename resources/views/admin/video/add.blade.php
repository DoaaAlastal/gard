    ...
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            ...
            <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                ...
                <li class="m-nav__item">
                    <a href="{{url('admin/video')}}" class="m-nav__link">
											<span class="m-nav__link-text">
												Videos
											</span>
                    </a>
		    	...
		    	<div class="m-portlet__head">
					<div class="m-portlet__head-caption">
						<div class="m-portlet__head-title">
							...
							<!--begin::Form-->
							<form class="m-form m-form--fit m-form--label-align-right" method="POST" action="{{ url('admin/video') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
								...
								<div class="m-portlet__body">
									<div class="form-group{{ $errors->has('en_title') ? ' has-error' : '' }} m-form__group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<input type="text" class="form-control m-input" name="en_title" placeholder="Enter English Video Title"  value="{{ old('en_title') }}">
                                        </div>
                                ...
                                @endif
                                    ...
                                    <div class="form-group{{ $errors->has('ar_title') ? ' has-error' : '' }} m-form__group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<input type="text" class="form-control m-input" name="ar_title" placeholder="Enter Arabic Video Title"  value="{{ old('ar_title') }}">
                                        </div>
                            ...
                            @endforeach
                                    ...
                                    <div class="form-group{{ $errors->has('url') ? ' has-error' : '' }} m-form__group row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <input type="text" class="form-control m-input" name="url" placeholder="Enter Video URL "  value="{{ old('url') }}">
                                        </div>
                                        @if ($errors->has('url'))
                                            <span class="help-block col-md-12">
									...
									<div class="m-form__actions m-form__actions">
										<div class="row">
											<div class="col-lg-9 ml-lg-auto">
												...
												<a class="btn btn-secondary" href="/admin/video">Cancel</a>
											</div>
										</div>
									</div>
                                </div>
