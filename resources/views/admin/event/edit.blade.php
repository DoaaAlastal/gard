		    	...
		    	<div class="m-portlet__head">
					<div class="m-portlet__head-caption">
						<div class="m-portlet__head-title">
							...
							<!--begin::Form-->
							<form class="m-form m-form--fit m-form--label-align-right" method="POST" action="{{ url('admin/event/'.$event->id) }}" enctype="multipart/form-data">
                            {{ csrf_field() }} 
                            ...
                            <input type="hidden" name="id" value="{{$event->id}}">
								<div class="m-portlet__body">
									...
									<div class="col-lg-4 col-md-9 col-sm-12">
											<input type="text" class="form-control m-input" name="en_title" placeholder="Enter English Event Title"  value="{{ $event->en_title }}">
                                ...
                                @endif
									...
									<div class="form-group{{ $errors->has('ar_title') ? ' has-error' : '' }} m-form__group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<input type="text" class="form-control m-input" name="ar_title" placeholder="Enter Arabic Event Title"  value="{{ $event->ar_title }}">
											<span class="m-form__help">
												Arabic Event Title.
											</span>
                                        </div>
                                ...
                                @endif
									...
									<div class="form-group m-form__group row{{ $errors->has('en_description') ? ' has-error' : '' }}">
												...
												<div class="col-lg-4 col-md-9 col-sm-12">
												<textarea class="form-control m-input" id="en_description" name="en_description" rows="3" value="">{{$event->en_description}}</textarea>
									...
									<div class="form-group m-form__group row{{ $errors->has('ar_description') ? ' has-error' : '' }}">
												...
												<div class="col-lg-4 col-md-9 col-sm-12">
												<textarea class="form-control m-input" id="ar_description" name="ar_description" rows="3" value="">{{$event->ar_description}}</textarea>
								...
								<div></div>
								<div class=" col-lg-4 col-md-9 col-sm-12">
									<input type="file" class="custom-file-input" id="big_image" name="big_image" value="{{ $event->big_image }}">
							...
							<div class="form-group m-form__group row{{ $errors->has('thumb_image') ? ' has-error' : '' }}">
								...
								<div></div>
								<div class=" col-lg-4 col-md-9 col-sm-12">
									<input type="file" class="custom-file-input" id="thumb_image" name="thumb_image" value="{{ $event->thumb_image }}">
                  ...
                  <strong>{{ $errors->first('thumb_image') }}</strong>
							...
							<div class="form-group m-form__group row {{ $errors->has('tags') ? ' has-error' : '' }}">
                              ...
                              @foreach($tags as $tag)
                               <option {{($event->tags)==$tag->id?"selected":""}} value='{{$tag->id}}'>{{$tag->en_name}}</option>
                            @endforeach
												</select>
												@if ($errors->has('tags'))
                                    <span class="help-block col-md-12">
									...
									<div class="form-group m-form__group row{{ $errors->has('en_location') ? ' has-error' : '' }}">
												...
												<div class="col-lg-4 col-md-9 col-sm-12">
												<textarea class="form-control m-input" id="en_location" name="en_location" rows="3" value="">{{$event->en_location}}</textarea>
									...
									<div class="form-group m-form__group row{{ $errors->has('ar_location') ? ' has-error' : '' }}">
												...
												<div class="col-lg-4 col-md-9 col-sm-12">
												<textarea class="form-control m-input" id="ar_location" name="ar_location" rows="3" value="">{{$event->ar_location}}</textarea>
									...
									<div class="form-group m-form__group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<div class="input-group date">
												<input type="text" class="form-control m-input"  name="start_at" readonly placeholder="Select date & time" id="m_datetimepicker_2" value="{{$event->start_at}}"/>
									...
									<div class="form-group m-form__group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<div class="input-group date">
												<input type="text" class="form-control m-input"  name="end_at" readonly placeholder="Select date & time" id="m_datetimepicker_2" value="{{$event->end_at}}"/>
												<div class="input-group-append">
													<span class="input-group-text">
														<i class="la la-calendar-check-o glyphicon-th"></i>
													</span>
									...
									<div class="form-group m-form__group row {{ $errors->has('video') ? ' has-error' : '' }}">
											...
											<div class="col-lg-4 col-md-9 col-sm-12">
												<input class="form-control m-input" type="url"  id="video" name="video" value="{{$event->video}}" >
											</div>
										</div>
                  <div class="form-group m-form__group row {{ $errors->has('IsOnline') ? ' has-error' : '' }}">
										<div class=" m-checkbox-list ">
												...
												<input {{($event->IsOnline)?"checked":""}} type="checkbox" name="IsOnline" id="IsOnline" value="1">
																		Is Online
																		<span></span>
																	</label>
											</div>
