...
@section('content')
    ...
    <div class="m-portlet">
        ...
        <!--begin::Form-->
        <form class="m-form m-form--fit m-form--label-align-right" method="POST" action="{{ url('instructor/topic/update') }}" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="m-form__actions m-form__actions">
                        <div class="row">
                            <div class="col-lg-9 ml-lg-auto">
                                ...
                                <button type="button" class="btn btn-secondary" onclick="window.location='{{url('instructor/course-topics/'.$course->id)}}'" >
                                    Cancel
                                </button>
                            </div>
                        </div>
