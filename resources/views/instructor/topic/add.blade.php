...
@section('content')
    ...
    <div class="m-portlet">
        ...
        <!--begin::Form-->
        <form class="m-form m-form--fit m-form--label-align-right" method="POST" action="{{ url('instructor/topic/store') }}" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="m-portlet__body">
                <div class="form-group{{ $errors->has('en_title') ? ' has-error' : '' }} m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="text" class="form-control m-input" name="en_title" placeholder="Enter English Topic Title"  value="{{ old('en_title') }}">
                ...
                <div class="form-group{{ $errors->has('ar_title') ? ' has-error' : '' }} m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="text" class="form-control m-input" name="ar_title" placeholder="Enter Arabic Topic Title"  value="{{ old('ar_title') }}">
                        <span class="m-form__help">
												Arabic Topic Title.
											</span>
                    </div>
                    ...
                    <div class="m-form__actions m-form__actions">
                        <div class="row">
                            <div class="col-lg-9 ml-lg-auto">
                                ...
                                <a class="btn btn-secondary" href="{{url('instructor/course-topics/'.$course->id)}}">Cancel</a>
                            </div>
                        </div>
                    </div>
                </div>
