        ...
        <div class="mr-auto">
            ...
            <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                ...
                <li class="m-nav__item">
                    <a href="{{url('instructor/posts/articles')}}" class="m-nav__link">
		    	...
		    	<div class="m-portlet__head">
					<div class="m-portlet__head-caption">
						<div class="m-portlet__head-title">
							...
							<!--begin::Form-->
							<form class="m-form m-form--fit m-form--label-align-right" method="POST" action="{{ url('instructor/posts') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
									...
									<div class="m-form__actions m-form__actions">
										<div class="row">
											<div class="col-lg-9 ml-lg-auto">
												...
												<a class="btn btn-secondary" href="/instructor/posts/{{$type}}">Cancel</a>
											</div>
										</div>
									</div>
                                </div>
