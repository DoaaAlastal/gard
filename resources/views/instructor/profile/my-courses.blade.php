                                        ...
                                        <div class="m-portlet__body">
                                            <div class="m-widget19">
                                                ...
                                                <div class="m-widget19__action">
                                                    <a href='{{url("instructor/profile/my-courses/course-topics/$course->id")}}'><button type="button" class="btn m-btn--pill btn-secondary m-btn m-btn--hover-brand m-btn--custom">
                                                            Course Topics
                                                        </button></a>
                                                </div>
                                            </div>
