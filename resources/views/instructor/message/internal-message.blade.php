		    	...
		    	<div class="m-portlet__head">
					<div class="m-portlet__head-caption">
						<div class="m-portlet__head-title">
							...
							<!--begin::Form-->
							<form class="m-form m-form--fit m-form--label-align-right" method="POST" action="{{ url('instructor/message/send-message') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
												...
												<div class="col-lg-9 col-md-9 col-sm-12">
                                                    ...
                                                    <option disabled selected> Select Receiver </option>
                                                        ...
                                                        @foreach($users as $user)
                                                            <option value="{{$user->email}}" @if($user->email ==Auth::guard('instructor')->user()->email) disabled @endif> {{$user->en_name}} </option>
                                                        @endforeach
