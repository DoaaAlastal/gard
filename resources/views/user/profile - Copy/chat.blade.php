            ...
            <div class="col-sx-12 col-sm-4 col-md-4">
              ...
              <div class="info p-20 bg-black-333">
                ...
                <h6 class="text-small text-white">
                  ...
                  @else
                  <i class="fa fa-circle text-danger"></i>  In Active
                  @endif
                </h6>
    ...
    <section>
      <div class="container">
        <div class="section-content">
            ...
            <div class="col-sx-12 col-sm-4 col-md-4">
              ...
              <div class="info p-20 bg-black-333">
                ...
                <h6 class="text-small text-white">
                  ...
                  @else
                  <i class="fa fa-circle text-danger"></i>  غير فعال
                  @endif
                </h6>
                <ul class="list angle-double-right m-0">
          ...
          <div class="type_msg">
            <div class="input_msg_write">
              <input type="text" class="write_msg" placeholder="اكتب الرسالة هنا" />
              <button class="msg_send_btn " type="button" style="left:0;"><i class="fa fa-paper-plane-o" aria-hidden="true"></i></button>
            </div>
          </div>
        </div>
      </div>
