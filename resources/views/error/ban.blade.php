...
<div class="m-grid m-grid--hor m-grid--root m-page">
    <div class="m-grid__item m-grid__item--fluid m-grid  m-error-1" style="background-image: url(/demo/assets/app/media/img//error/bg1.jpg);">
        <div class="m-error_container">
            ...
            <p class="m-error_desc">
                OOPS! You Are Banned from using our system!!
            </p>
        </div>
    </div>
</div>
